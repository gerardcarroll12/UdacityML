...
get_ipython().system('wget https://raw.githubusercontent.com/udacity/deep-learning-v2-pytorch/3bd7dea850e936d8cb44adda8200e4e2b5d627e3/intro-to-pytorch/helper.py')
...
def load_checkpoint(filepath):
    ...
    model.optimizer.load_state_dict = checkpoint['optimizer.state_dict']
...
def imshow(image, ax=None, title=None):
    ...
    pil_image = pil_image.numpy().transpose((1, 2, 0))
    
    # Undo preprocessing
    mean = np.array([0.485, 0.456, 0.406])
    std = np.array([0.229, 0.224, 0.225])
    pil_image = std * image + mean
    
    # Image needs to be clipped between 0 and 1 or it looks like noise when displayed
    pil_image = np.clip(image, 0, 1)
